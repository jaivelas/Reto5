...
public class CategoryServicio {
    ...
    /* los if es para hacer validacion de que los campos esten llenos*/
    ...
    /* aca lso if se usan para verificar que los datos qu eno se actualizan no
    esten en blanco*/
  ...
  /* la funcion .map recorre la tabla buscando un id
     la funcion .orElse  nos permite definir una respuesta si 
     sigue false (no encontro el Id) */  
